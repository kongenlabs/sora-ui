  ...
  return (
    <input
      className={cx(
        ...
        // Primary color
        'data-[color=primary]:border-primary-border data-[color=primary]:text-on-primary-container data-[color=primary]:placeholder:text-on-primary-container/30',
        ...
        // Secondary color
        'data-[color=secondary]:border-secondary-border data-[color=secondary]:text-on-secondary-container data-[color=secondary]:placeholder:text-on-secondary-container/30',
        ...
        // Tertiary color
        'data-[color=tertiary]:border-tertiary-border data-[color=tertiary]:text-on-tertiary-container data-[color=tertiary]:placeholder:text-on-tertiary-container/30',
